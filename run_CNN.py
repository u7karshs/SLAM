...
if __name__ == '__main__':
   ...
   '''
    ...
    work_dir = "C:/Users/Utkarsh/Desktop/DL/MAIN/SWLM/work_dir/"
    dataset_path = "C:\\Users\\Utkarsh\\Desktop\\DL\MAIN\\SWLM\\dataset_path\\"
...
#            print("files in diff cat: {}".format(files_in_diff_cat))
        ...
        while((loss > loss_th) or (vloss > vloss_th) or (acc < acc_th)):           
        # for embeddings under control
    ...
    model.save(work_dir + sys.argv[0] + "final_model.h5")
